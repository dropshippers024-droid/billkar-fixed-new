...
import { FileText, Users, IndianRupee, Clock, CheckCircle2, Zap, Shield, TrendingUp } from "lucide-react";
        ...
        <div>
          ...
          >
            ...
            <span className="relative">
              <span className="relative z-10" style={{ color: "#fde68a" }}>Quickly</span>
            </span>
          </motion.h1>
          ...
          >
            No credit card required · Free 50 invoices/month · Setup in 2 minutes
          </motion.p>
        </div>
